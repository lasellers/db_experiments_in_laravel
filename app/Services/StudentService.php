...
class StudentService
{
    ...
    public function teachers()
    {
        return DB::table('students')
            ->select('students.id as student_id', 'students.last_name', 'students.middle_name', 'students.first_name',
                'teachers.id as teacher_id', 'teachers.last_name', 'teachers.first_name', 'teachers.email',
                'courses.course', 'courses.teacher_id as course_teacher_id')
